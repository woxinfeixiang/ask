	...
	<form action="<?php echo U('edit');?>" method="post">
		<table class="table">
			...
			<tr>
				...
				<td>
					+ <input type="text" name="lv_login" value="<?php echo (C("lv_login")); ?>" class="len150" />
				</td>
			</tr>
			<tr>
				<td align="right">提问: </td>
				<td>
					+ <input type="text" name="lv_ask" value="<?php echo (C("lv_ask")); ?>" class="len150" />
				</td>
			</tr>
			<tr>
				<td align="right">回答: </td>
				<td>
					+ <input type="text" name="lv_answer" value="<?php echo (C("lv_answer")); ?>" class="len150" />
				</td>
			</tr>
			<tr>
				<td align="right">采纳答案: </td>
				<td>
					+ <input type="text" name="lv_adopt" value="<?php echo (C("lv_adopt")); ?>" class="len150" />
				</td>
			</tr>
		</table>
				<table class='table'>
			...
			<tr>
				<td>LV13:</td>
				<td>
					<input type="text" name='lv13' value='<?php echo (C("lv13")); ?>' class='len100'/>
				</td>
				<td>LV14:</td>
				<td>
